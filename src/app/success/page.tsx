    ...
    <div className="bg-gray-900 min-h-screen">
      <main>
        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl pt-10 lg:flex lg:px-8 lg:pt-40">
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              ...
              <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                Our wallet, your dreams.
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Find out why our L2 technology simply solves everything.
              </p>
              <p className="text-lg leading-8 text-gray-300 pb-2">
                No rug pulls. Promise.
              </p>
